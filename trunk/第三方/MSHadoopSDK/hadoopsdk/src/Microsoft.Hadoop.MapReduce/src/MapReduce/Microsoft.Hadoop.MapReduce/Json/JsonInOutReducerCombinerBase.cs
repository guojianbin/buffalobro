...
{
    /// <summary>
    /// Base class for a reducer/combiner that reads in JSON-encoded values and emits JSON-encoded values.
    /// </summary>
    /// <typeparam name="TValueIn">The type of the value in.</typeparam>
    /// <typeparam name="TValueOut">The type of the value out.</typeparam>
    public abstract class JsonInOutReducerCombinerBase<TValueIn, TValueOut> : ReducerCombinerBase 
    {
        /// <summary>
        ...
        /// <param name="values">The values.</param>
        /// <param name="context">The context.</param>
        public abstract void Reduce(string key, IEnumerable<TValueIn> values, JsonReducerCombinerContext<TValueOut> context);
    }
}
