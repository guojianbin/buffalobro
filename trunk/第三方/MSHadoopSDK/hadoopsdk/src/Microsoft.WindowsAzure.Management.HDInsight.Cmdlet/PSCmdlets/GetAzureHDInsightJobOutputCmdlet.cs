...
namespace Microsoft.WindowsAzure.Management.HDInsight.Cmdlet.PSCmdlets
{
    ...
    public class GetAzureHDInsightJobOutputCmdlet : AzureHDInsightCmdlet, IGetAzureHDInsightJobOutputBase
    {
        ...
        [Parameter(Mandatory = false,
                  HelpMessage = "The target directory to download the task logs to.")]
        ...
        /// <inheritdoc />
        [Parameter(Mandatory = false,
                    HelpMessage = "Specify this switch to get the Standard error logs.")]
        public SwitchParameter StandardError { get; set; }

        /// <inheritdoc />
        [Parameter(Mandatory = false,
                    HelpMessage = "Specify this switch to get the Standard output logs.")]
        public SwitchParameter StandardOutput { get; set; }

        /// <inheritdoc />
        [Parameter(Mandatory = false,
                    HelpMessage = "Specify this switch to get the Task log summary.")]
        public SwitchParameter TaskSummary { get; set; }

        /// <inheritdoc />
        [Parameter(Mandatory = false,
                    HelpMessage = "Specify this switch to download the task logs.")]
        ...
        protected override void EndProcessing()
        {
            ...
            try
            {
                ...
                {
                    var contents = new StreamReader(output).ReadToEnd();
