...
namespace Microsoft.WindowsAzure.Management.HDInsight
{
    ...
    /// </summary>
    public sealed class OozieConfiguration
    {
        /// <summary>
        /// Initializes a new instance of the OozieConfiguration class.
        /// </summary>
        public OozieConfiguration()
        {
        ...
        /// </summary>
        public WabStorageAccountConfiguration AdditionalSharedLibraries { get; set; }

        /// <summary>
        /// Gets or sets the location to find additional Oozie executables.
        /// </summary>
        public WabStorageAccountConfiguration AdditionalActionExecutorLibraries { get; set; }
    }
}
