...
namespace Microsoft.WindowsAzure.Management.HDInsight
{
    ...
    /// Connection logic.
    /// </summary>
    internal interface IHDInsightSubscriptionCertificateCredentialsFactory
    {
        /// <summary>
        ...
        /// </returns>
        IHDInsightCertificateCredential Create(IHDInsightCertificateCredential credentials);
    }
}