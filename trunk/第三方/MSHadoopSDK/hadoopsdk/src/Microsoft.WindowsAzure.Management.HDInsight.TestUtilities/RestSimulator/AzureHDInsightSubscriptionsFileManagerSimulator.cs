...
namespace Microsoft.WindowsAzure.Management.HDInsight.TestUtilities.RestSimulator
{
    ...
    {
        private const string sampleSettingsFile = "<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
...
"      <SubscriptionId>03453212-1457-4952-8b31-687db8e28af2</SubscriptionId> " +
"    </AzureSubscriptionData>" +
"    <AzureSubscriptionData>" +
"      <ActiveDirectoryEndpoint i:nil=\"true\" /> " +
"      <ActiveDirectoryTenantId i:nil=\"true\" /> " +
...
"      <LoginType i:nil=\"true\" /> " +
"      <ManagementCertificate>8577FB6163323B956B83377821E4C755A9CD7675</ManagementCertificate> " +
"      <ManagementEndpoint>https://management.core.windows.net/</ManagementEndpoint> " +
"      <Name>HDI Experience RDFE - Windows Azure Internal Consumption</Name> " +
"      <RegisteredResourceProviders xmlns:d4p1=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\" /> " +
"      <SubscriptionId>bbad5395-302e-4c60-a071-9921fd7cabb7</SubscriptionId> " +
"    </AzureSubscriptionData>" +
"    <AzureSubscriptionData>" +
"      <ActiveDirectoryEndpoint i:nil=\"true\" /> " +
"      <ActiveDirectoryTenantId i:nil=\"true\" /> " +
...
"      <IsDefault>false</IsDefault>" +
"      <LoginType i:nil=\"true\" /> " +
"      <ManagementCertificate>55AE8C51E9113CBC13854833A02A48F3AB922D7B</ManagementCertificate> " +
"      <ManagementEndpoint>https://management.core.windows.net/</ManagementEndpoint> " +
"      <Name>HDI Experience SDK - Windows Azure Internal Consumption</Name> " +
"      <RegisteredResourceProviders xmlns:d4p1=\"http://schemas.microsoft.com/2003/10/Serialization/Arrays\" /> " +
"      <SubscriptionId>1588b2ba-5646-4a39-b6b5-a753857fdbc3</SubscriptionId> " +
"    </AzureSubscriptionData>" +
"    <AzureSubscriptionData>" +
"      <ActiveDirectoryEndpoint i:nil=\"true\" /> " +
"      <ActiveDirectoryTenantId i:nil=\"true\" /> " +
...
"</ProfileData>";
        ...
        internal IEnumerable<SubscriptionData> LoadSubscriptionData()
        {
            ...
            var settingsFileBytes = Encoding.UTF8.GetBytes(sampleSettingsFile);
