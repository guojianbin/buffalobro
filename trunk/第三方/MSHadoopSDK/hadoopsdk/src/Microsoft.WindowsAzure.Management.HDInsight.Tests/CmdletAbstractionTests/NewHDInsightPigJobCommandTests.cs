...
namespace Microsoft.WindowsAzure.Management.HDInsight.Tests.CmdletAbstractionTests
{
    ...
    public class NewHDInsightPigJobCommandTests : IntegrationTestBase
    {
        ...
        public void CanCreateNewPigDefinition()
        {
            ...
            var newPigJobDefinitionCommand = ServiceLocator.Instance.Locate<IAzureHDInsightCommandFactory>().CreateNewPigJobDefinition();
            newPigJobDefinitionCommand.Query = pigJobDefinition.Query;
            newPigJobDefinitionCommand.EndProcessing();

            var pigJobFromCommand = (AzureHDInsightPigJobDefinition)newPigJobDefinitionCommand.Output.ElementAt(0);
        ...
        public void CanCreateNewPigDefinition_WithArguments()
        {
            ...
            foreach (var parameter in pigJobDefinition.Arguments)
            {
                Assert.IsTrue(
