...
{
    /// <summary>
    /// This factory creates concrete instances of <see cref="IRdfeResourceTypeFinderClient"/>.
    /// </summary>
    internal interface IRdfeResourceTypeFinderFactory
    {
        /// <summary>
        ...
        /// </returns>
        IRdfeResourceTypeFinderClient Create(IHDInsightSubscriptionCredentials credentials, IAbstractionContext context, bool ignoreSslErrors, string schemaVersion);
    }
}
