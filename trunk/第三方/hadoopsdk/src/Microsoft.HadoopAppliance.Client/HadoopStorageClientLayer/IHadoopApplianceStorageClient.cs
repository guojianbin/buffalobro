...
namespace Microsoft.HadoopAppliance.Client.HadoopStorageClientLayer
{
    ...
    public interface IHadoopApplianceStorageClient : IHadoopStorageClient
    {
        ...
        bool SetReplicationFactor(string path, short replicationFactor);
        ...
        bool SetPermissions(string path, string permissions);
        ...
        /// <returns>True if the operation succeded.</returns>
        bool SetOwner(string path, string owner, string group);
