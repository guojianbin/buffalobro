...
namespace Microsoft.WindowsAzure.Management.HDInsight.Cmdlet.PSCmdlets
{
    ...
    public class RemoveClusterHDInsightClusterCmdlet : AzureHDInsightCmdlet, IRemoveAzureHDInsightClusterBase
    {
        ...
        /// <inheritdoc />
        [Parameter(Position = 5, Mandatory = false, HelpMessage = "The CloudServiceName to use when managing the HDInsight cluster.",
            ParameterSetName = AzureHdInsightPowerShellConstants.ParameterSetClusterByNameWithSpecificSubscriptionCredentials)]
        ...
        /// <inheritdoc />
        [Parameter(Position = 3, Mandatory = false, HelpMessage = "The azure location where the new cluster should be created.",
            ParameterSetName = AzureHdInsightPowerShellConstants.ParameterSetClusterByNameWithSpecificSubscriptionCredentials)]
