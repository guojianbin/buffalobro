...
{
    internal class AzureHdInsightPowerShellHardCodes
    {
        public const string AzureHDInsightCluster = "AzureHDInsightCluster";
        public const string AzureHDInsightConfig = "AzureHDInsightConfig";
        ...
        public const string AliasUser = "User";
        public const string AliasPwd = "Pwd";
