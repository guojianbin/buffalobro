...
namespace Microsoft.Hadoop.Client
{
    ...
    /// <summary>
    /// Represents a list of applications on an HDInsight cluster.
    /// </summary>
    internal class ApplicationList
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets an enumeration of applications.
        /// </summary>
        internal IEnumerable<ApplicationDetails> Applications { get; private set; }
    }
}
