...
namespace ManagementLib.BQLEntity
{
    ...
    {
        private static Management_View_InSorageRecode _View_InSorageRecode = new Management_View_InSorageRecode();
    
        public static Management_View_InSorageRecode View_InSorageRecode
        {
            get
            {
                return _View_InSorageRecode;
            }
        }
    }
    ...
    ///  
    /// </summary>
    public partial class Management_View_InSorageRecode : BQLEntityTableHandle
    {
        ...
        public Management_View_InSorageRecode(BQLEntityTableHandle parent,string propertyName) 
        :this(typeof(ManagementLib.View_InSorageRecode),parent,propertyName)
        {
        ...
        /// <param name="parent">父表信息</param>
        /// <param name="propertyName">属性名</param>
        public Management_View_InSorageRecode(Type entityType,BQLEntityTableHandle parent,string propertyName) 
        ...
        /// 初始化本类的信息
        /// </summary>
        public Management_View_InSorageRecode() 
            :this(null,null)
        {
        }
    }
