...
namespace ManagementLib.BQLEntity
{
    ...
    {
        private static Management_View_SampleGressionRecode _View_SampleGressionRecode = new Management_View_SampleGressionRecode();
    
        public static Management_View_SampleGressionRecode View_SampleGressionRecode
        {
            get
            {
                return _View_SampleGressionRecode;
            }
        }
    }
    ...
    ///  
    /// </summary>
    public partial class Management_View_SampleGressionRecode : BQLEntityTableHandle
    {
        ...
        public Management_View_SampleGressionRecode(BQLEntityTableHandle parent,string propertyName) 
        :this(typeof(ManagementLib.View_SampleGressionRecode),parent,propertyName)
        {
        ...
        /// <param name="parent">父表信息</param>
        /// <param name="propertyName">属性名</param>
        public Management_View_SampleGressionRecode(Type entityType,BQLEntityTableHandle parent,string propertyName) 
        ...
        /// 初始化本类的信息
        /// </summary>
        public Management_View_SampleGressionRecode() 
            :this(null,null)
        {
        }
    }
