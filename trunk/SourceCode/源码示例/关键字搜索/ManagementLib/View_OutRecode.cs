...
namespace ManagementLib
{
    ...
    /// 
    /// </summary>
    public partial class View_OutRecode: Buffalo.DB.CommBase.BusinessBases.ThinModelBase
    {
        ///<summary>
        ///
        ///</summary>
        ...
        private static ModelContext<View_OutRecode> _____baseContext=new ModelContext<View_OutRecode>();
        /// <summary>
        /// 获取查询关联类
        /// </summary>
        /// <returns></returns>
        public static ModelContext<View_OutRecode> GetContext() 
        {
