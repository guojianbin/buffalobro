...
namespace ManagementLib
{
    ...
    /// 
    /// </summary>
    public partial class View_SampleMove: Buffalo.DB.CommBase.BusinessBases.ThinModelBase
    {
        ///<summary>
        ///
        ///</summary>
        ...
        private static ModelContext<View_SampleMove> _____baseContext=new ModelContext<View_SampleMove>();
        /// <summary>
        /// 获取查询关联类
        /// </summary>
        /// <returns></returns>
        public static ModelContext<View_SampleMove> GetContext() 
        {
