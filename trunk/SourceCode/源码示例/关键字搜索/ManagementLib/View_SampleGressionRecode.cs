...
namespace ManagementLib
{
    ...
    /// 
    /// </summary>
    public partial class View_SampleGressionRecode: Buffalo.DB.CommBase.BusinessBases.ThinModelBase
    {
        ///<summary>
        ///
        ///</summary>
        ...
        private static ModelContext<View_SampleGressionRecode> _____baseContext=new ModelContext<View_SampleGressionRecode>();
        /// <summary>
        /// 获取查询关联类
        /// </summary>
        /// <returns></returns>
        public static ModelContext<View_SampleGressionRecode> GetContext() 
        {
