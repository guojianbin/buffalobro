...
namespace ManagementLib
{
    ...
    /// 
    /// </summary>
    public partial class View_sampleRecord_Users: Buffalo.DB.CommBase.BusinessBases.ThinModelBase
    {
        ///<summary>
        ///
        ///</summary>
        ...
        ///
        ///</summary>
        protected string _sampleRecord;
        ...
        public string SampleRecord
        {
            ...
            {
                _sampleRecord=value;
                OnPropertyUpdated("SampleRecord");
            }
        }
        ///<summary>
        ///
        ...
        private static ModelContext<View_sampleRecord_Users> _____baseContext=new ModelContext<View_sampleRecord_Users>();
        /// <summary>
        /// 获取查询关联类
        /// </summary>
        /// <returns></returns>
        public static ModelContext<View_sampleRecord_Users> GetContext() 
        {
