...
namespace Buffalobro.DB.DataBaseAdapter.SqlServer2K5Adapter
{
    ...
    public class CutPageSqlCreater
    {
        ...
        private static string CreateCutPageSql(SelectCondition objCondition, PageContent objPage)
        {
            ...
            {
                return SQLCommon.DataBaseAdapter.SqlServer2KAdapter.CutPageSqlCreater.GetFristPageSql(objCondition, objPage);
            }
            ...
            else 
            {
                ...
                sql.Append("  from (");
                SQLCommon.DataBaseAdapter.SqlServer2KAdapter.CutPageSqlCreater.GetGroupPart(objCondition, sql);
                sql.Append(") [_tmpInnerTable]");
            }
