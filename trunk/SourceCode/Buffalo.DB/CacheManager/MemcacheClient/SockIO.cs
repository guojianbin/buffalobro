    ...
    public class SockIO
    {
            ...
            : this()
        {
            if (host == null || host.Length == 0)
                throw new ArgumentNullException("host", "null host");
        ...
        protected static Socket GetSocket(String host, int port, int timeout)
        {
            ...
            throw new IOException(("connect timeout").Replace("$$timeout$$", timeout.ToString(new System.Globalization.NumberFormatInfo())));
        }
        ...
        public void TrueClose()
        {
            ...
            {
                err = true;
                errMsg.Append("socket already closed");
            }
            ...
            if (_socket != null)
            {
                ...
                {
                    errMsg.Append(("error closing socket").Replace("$$ToString$$", ToString()).Replace("$$Host$$", Host) + System.Environment.NewLine);
        ...
        public string ReadLine()
        {
            if (_socket == null || !_socket.Connected)
            {
                ...
                throw new IOException("read closed socket");
            }
        ...
        public void Flush()
        {
            if (_socket == null || !_socket.Connected)
            {
                ...
                throw new IOException("write closed socket");
            }
