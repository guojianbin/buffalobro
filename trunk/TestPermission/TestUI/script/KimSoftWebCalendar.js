...
* @update
*/
function Calendar(beginYear, endYear, lang, dateFormatStyle,curWord,curBg,sunWord,
satWord,tdWordLight,tdWordDark,tdBgOut,tdBgOver,trWord,trBg,inputBorder,inputBg) {
...
this.colors = {
"cur_word"      : curWord, //当日日期文字颜色
"cur_bg"        : curBg, //当日日期单元格背影色
"sun_word"      : sunWord, //星期天文字颜色
"sat_word"      : satWord, //星期六文字颜色
"td_word_light" : tdWordLight, //单元格文字颜色
"td_word_dark" : tdWordDark, //单元格文字暗色
"td_bg_out"     : tdBgOut, //单元格背影色
"td_bg_over"    : tdBgOver, //单元格背影色
"tr_word"       : trWord, //日历头文字颜色
"tr_bg"         : trBg, //日历头背影色
"input_border" : inputBorder, //input控件的边框颜色
"input_bg"      : inputBg   //input控件的背影色
}
this.draw();
this.bindYear();
this.bindMonth();
