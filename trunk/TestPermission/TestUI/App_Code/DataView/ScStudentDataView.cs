...
namespace TestPerLib.DataView
{
	public class ScStudentDataView:DataViewer
	{
		...
		private DataItem _belongClass=null;
		private DataItem BelongClass
		{
			get
			{
				return _belongClass;
		...
		:base(entityHandle,true,true,true)
		{
			...
			_age=CreateDataItem("Age",typeof(int),true,true,true,SumType.Sum,null);
			
			_belongClass=CreateDataItem("BelongClass",typeof(ScClass),true,true,true,SumType.None,null);
